...
const formatDateForInput = (date: string | null): string | null => {
    if (!date) {
        return null;
    }
...
const form = useForm({
    ...
    long_description: props.position.long_description,
    company_id: props.position.company_id,
    seniority: props.position.seniority || '',
    ...
    expires_at: formatDateForInput(props.position.expires_at),
...
const submit = () => {
    form.post(admin.positions.update(props.position.id).url, {
        preserveScroll: true,
        onSuccess: () => {
...
const breadcrumbs = [
    ...
    {
        title: 'Edit',
        href: admin.positions.edit(props.position.id).url,
    },
];
</script>

<template>
    <Head :title="`Edit ${position.title} - Admin`" />
        ...
        <div class="mx-auto w-full max-w-7xl p-4">
            <div class="mb-6">
                ...
                <p class="text-sm text-muted-foreground mt-1">
                    Update the details for this job position. You can change status, expiration, and listing tier directly.
                </p>
            </div>
            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
                            ...
                            <CardContent class="pt-6">
                                <div class="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="A brief overview that will appear in job listings (max 500 characters)"
                                        rows="3"
                                        maxlength="500"
                    ...
                    <div class="space-y-6 lg:col-span-1">
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle class="text-base">Admin Controls</CardTitle>
                                <CardDescription>
                                    Set status, expiration, and listing tier
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    <Label for="listing_type">Listing Tier</Label>
                                    ...
                                    <p v-if="form.errors.listing_type" class="text-sm text-red-500">
