...
const submit = () => {
    form.post(admin.positions.store().url, {
        preserveScroll: true,
        onSuccess: () => {
...
const breadcrumbs = [
    ...
    {
        title: 'Create',
        href: admin.positions.create().url,
    },
];
</script>

<template>
    <Head title="Create Position - Admin" />
        ...
        <div class="mx-auto w-full max-w-7xl p-4">
            <div class="mb-6">
                ...
                <p class="text-sm text-muted-foreground mt-1">
                    Create a position at no cost. You can set status, expiration, and listing tier directly.
                </p>
            </div>
