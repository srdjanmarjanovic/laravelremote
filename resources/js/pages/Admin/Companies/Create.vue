...
const submit = () => {
    form.post(admin.companies.store().url, {
        preserveScroll: true,
        onSuccess: () => {
            toast.success('Company created successfully!');
        },
        onError: () => {
            toast.error('There was an error creating the company. Please check the form.');
        },
    });
};
...
const breadcrumbs = [
    ...
    },
    {
        ...
        href: admin.companies.create().url,
    },
];
</script>

<template>
    <Head title="Create Company - Admin" />
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end gap-4">
                    <Button
                        type="button"
                        variant="outline"
                        @click="$inertia.visit(admin.companies.index().url)"
                    >
                        Cancel
                    </Button>
