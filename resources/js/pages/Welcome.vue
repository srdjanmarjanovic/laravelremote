...
<template>
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-primary"
                >
                    Dashboard
                </Link>
                <template v-else>
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-[20px] shadow-lg lg:rounded-tl-lg lg:rounded-br-none lg:p-20"
                >
                    <h1 class="mb-1 font-medium text-card-foreground">Let's get started</h1>
                        ...
                        >
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-primary underline underline-offset-4 hover:text-primary/80"
                                >
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a
                                ...
                                target="_blank"
                                class="inline-block rounded-sm border border-primary bg-primary px-5 py-1.5 text-sm leading-normal text-primary-foreground hover:bg-primary/90"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-accent lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <svg
